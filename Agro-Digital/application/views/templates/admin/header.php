...
<head>
    ...
    <title><?php (isset($titulo) ? $titulo : 'Bienvenido') ?> </title>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?= base_url('index.php/estudiante/Estudiantes') ?>" class="nav-link">Inicio</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu settings-menu dropdown-menu-right">
                        ...
                        <li>
                            <a class="dropdown-item" href="<?= base_url('index.php/Login/cerrarSesion'); ?>">
                                <i class="fas fa-sign-out-alt"></i> Salir</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a id="modo" class="nav-link" href="#" data-toggle="dropdown" aria-label="Open Profile Menu">
