    ...
    <section class="content-header">
        ...
        <div class="card">
            ...
            <div class="card-body d-flex justify-content-end">
                ...
                <a href="<?= base_url('index.php/administrador/Docentes/createUserView') ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Añadir docente</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="../Docentes/deleteUser/<?= $usuario->usuario_id ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Borrar</a></td>
                                    <td><a href="../Docentes/editUser/<?= $usuario->usuario_id ?>" class="btn btn-success"><i class="fas fa-edit"></i> Editar</a></td>
                                </tr>
                            <?php
                            }
                        } else {
